...
notesContainer.addEventListener("click", function (e) {
  //the value of this (function(e)) inside refers to the element the event is bound to (notesContainer here).arrow functions don’t have their own this. They take this from the outer scope (lexical this).
  if (e.target.tagName === "IMG") {
    ...
    notes.forEach((note) => {
      note.onkeyup = function () {
        // onkeyup is an event listener, every time you type something and release a key, it auto-saves the notes to storage.
        storeNotes();
      };
    });
  }
